...
def test_card():
    ...
    print(f"   ✅ str(goblin): {goblin}")
    print(f"   ✅ repr(goblin): {repr(goblin)}")
    ...
    assert forest.is_land() == True
    assert forest.is_permanent() == True
    print(f"   ✅ {forest.name} created successfully")
